...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// It can inherit things from the parents. The parents will descend properties. The global scope doesn't know about internal variable.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    let lowerPopulation = zooAnimals.filter(item => item.population<5);
  ...
  */
  ...
  function USApop(zooAnimals){
    let totalPopulation = zooAnimals.reduce(function(accumulator, item){
  ...
  */
  ...
  function consume(value1, value2, callback){
...
function greeting(/*Your Code Here */){
  ...
  function greeting(value1, value2){
    return `Hello ${value1} ${value2}, nice to meet you!`;
